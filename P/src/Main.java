...
class TetrisBoard extends JPanel implements ActionListener {
    ...
    private void drawSquare(Graphics g, int x, int y, Tetrominoes shape) {
        Color colors[] = { Color.black, Color.red, Color.blue, Color.cyan, Color.green, Color.magenta, Color.orange, Color.pink };
...
class Shape {
    ...
    public void setShape(Tetrominoes shape) { pieceShape = shape; }
